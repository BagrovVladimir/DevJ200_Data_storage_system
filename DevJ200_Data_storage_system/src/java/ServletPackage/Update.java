...
//        processRequest(request, response);
        ...
        int idAddress = toInt(request.getParameter("idAddressUpdate"));
        String city = request.getParameter("cityUpdate");
        String street = request.getParameter("streetUpdate");
        int num = toInt(request.getParameter("numUpdate"));
        int subnum = toInt(request.getParameter("subnumUpdate"));
        int flat = toInt(request.getParameter("flatUpdate"));
        String extra = request.getParameter("extraUpdate");
        
        int idClient = toInt(request.getParameter("idClientUpdate"));
        ...
        for (Client client : clients) {
            if(client.getIdClient()==idAddress)
                tempClient = client;
            }
